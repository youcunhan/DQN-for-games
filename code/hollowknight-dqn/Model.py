...
class Model:
    ...
    def _build_model(self,layer_dims):
        ...
        # resnet blocks
        self.private_act_model.add(self.build_resblock(64, layer_dims[0], name='Resnet_1'))
        self.private_act_model.add(self.build_resblock(96, layer_dims[1], name='Resnet_2', stride=2))
        self.private_act_model.add(self.build_resblock(128, layer_dims[2], name='Resnet_3', stride=2))
        self.private_act_model.add(self.build_resblock(256, layer_dims[3], name='Resnet_4', stride=2))
        self.private_act_model.add(GlobalAveragePooling2D())
        self.private_act_model.add(Dense(self.act_dim, name="d1"))
        ...
        # resnet blocks
        self.private_move_model.add(self.build_resblock(64, layer_dims[0], name='Resnet_1'))
        self.private_move_model.add(self.build_resblock(96, layer_dims[1], name='Resnet_2', stride=2))
        self.private_move_model.add(self.build_resblock(128, layer_dims[2], name='Resnet_3', stride=2))
        self.private_move_model.add(self.build_resblock(256, layer_dims[3], name='Resnet_4', stride=2))
    ...
    def build_resnet18(self):
        self._build_model([2,2,2,2])

    def build_resnet34(self):
        self._build_model([3,4,6,3])
